...
from slots.forms import PersonalInformationForm, ServiceForm, StaffDaysOffForm, StaffWorkingHoursForm
from slots.messages_ import appt_updated_successfully
from slots.settings import APPOINTMENT_PAYMENT_URL
from slots.utils.date_time import (
    convert_12_hour_time_to_24_hour_time, convert_str_to_date, convert_str_to_time, get_ar_end_time)
from slots.utils.db_helpers import (
    ...
    working_hours_exist)
from slots.utils.email_ops import send_reset_link_to_staff_member
from slots.utils.error_codes import ErrorCode
from slots.utils.json_context import convert_appointment_to_json, get_generic_context, json_response
from slots.utils.permissions import check_entity_ownership
from slots.utils.session import handle_email_change
