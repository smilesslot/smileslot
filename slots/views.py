...
from slots.forms import AppointmentForm, AppointmentRequestForm, ClientDataForm, SlotForm
from slots.logger_config import get_logger
from slots.models import (
    Appointment, AppointmentRequest, RescheduleHistory, Config, DayOff, EmailVerificationCode,
    PasswordResetToken, Service,
    StaffMember
)
from slots.settings import check_q_cluster
...
from slots.utils.email_ops import notify_admin_about_appointment, notify_admin_about_reschedule, \
    send_reschedule_confirmation_email, \
    send_thank_you_email
from slots.utils.session import get_appointment_data_from_session, handle_existing_email
from slots.utils.view_helpers import get_locale
