...
from slots.decorators import (
    require_ajax, require_staff_or_superuser, require_superuser, require_user_authenticated)
from slots.forms import PersonalInformationForm, ServiceForm, StaffAppointmentInformationForm, StaffMemberForm
from slots.messages_ import appt_updated_successfully
from slots.models import Appointment, DayOff, StaffMember, WorkingHours
from slots.services import (
...
from slots.utils.json_context import (
    convert_appointment_to_json, get_generic_context, get_generic_context_with_extra, handle_unauthorized_response,
    json_response)
from slots.utils.permissions import check_extensive_permissions, check_permissions, \
