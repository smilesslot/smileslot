...
from slots.logger_config import get_logger
from slots.settings import (
...
from slots.utils.date_time import combine_date_and_time, get_weekday_num
...
Appointment = apps.get_model('slots', 'Appointment')
AppointmentRequest = apps.get_model('slots', 'AppointmentRequest')
WorkingHours = apps.get_model('slots', 'WorkingHours')
DayOff = apps.get_model('slots', 'DayOff')
PaymentInfo = apps.get_model('slots', 'PaymentInfo')
StaffMember = apps.get_model('slots', 'StaffMember')
Config = apps.get_model('slots', 'Config')
Service = apps.get_model('slots', 'Service')
EmailVerificationCode = apps.get_model('slots', 'EmailVerificationCode')
RescheduleHistory = apps.get_model('slots', 'RescheduleHistory')
...
def get_website_name() -> str:
    ...
    """
    from slots.models import Config
